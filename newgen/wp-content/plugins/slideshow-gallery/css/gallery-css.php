...
#slideshow-wrapper { position:relative; width:80%;  margin:0; display:none; }
#slideshow-wrapper * { margin:0; padding:0; }
#fullsize { position:relative; z-index:1; overflow:hidden; width:99.7%; height:600px; border:1px #CCC solid; }
...
<?php if (empty($styles['resizeimages']) || $styles['resizeimages'] == "Y") : ?>#image img { position:absolute; border:none; width:100%; height:auto; }<?php else : ?>#image img { position:absolute; border:none; width:auto; }<?php endif; ?> 
...
#slidearea { float:left; background:<?php echo $styles['background']; ?>; position:relative; width:93%; margin-left:5px; height:81px; overflow:hidden; }
