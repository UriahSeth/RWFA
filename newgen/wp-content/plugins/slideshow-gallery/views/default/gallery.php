...
<div id="imint" style="width:100px; height:20px; float: right"><a href="#" onClick="show_prompt()" >I am Interested</a></div>
...
<div style="width:200px; height:30px; float:left;  "></div>
<div style="width:61px; height:30px; float:right;"   ><img src="images/shareblack.jpg" width="61" height="21"></div>
<div style="width:43px; height:30px; float:right;"   ><img src="images/faceblack.jpg" width="43" height="21"></div>
