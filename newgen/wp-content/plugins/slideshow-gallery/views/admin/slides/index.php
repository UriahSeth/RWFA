			...
			<table class="widefat">
				<thead>
					<tr>
                        ...
                        <th><?php _e('For Sale', $this -> plugin_name); ?> <?php //_e('Link', $this -> plugin_name); ?></th>
						<th><?php _e('Date', $this -> plugin_name); ?></th>
						<th><?php _e('Order', $this -> plugin_name); ?></th>
                        <th><?php _e('Home Page', $this -> plugin_name); ?></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
				...
				<tbody>
					<?php foreach ($slides as $slide) : ?>
						<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
                            ...
                            <td>
                            	<?php if (!empty($slide -> show_at_home) && $slide -> show_at_home == 1) : ?>
                                	<span style="color:green;"><?php _e('Yes', $this -> plugin_name); ?></span>
                                <?php else : ?>
                                	<span style="color:red;"><?php _e('No', $this -> plugin_name); ?></span>
                                <?php endif; ?>
