...
#searchform a{ padding:4px 0 2px 0; margin:0px;} 
</style>
<![endif]-->
...
<!--[if IE 8]>
<style type="text/css" media="screen">
#searchform a{ padding:4px 0 4px 0; margin:0px;} 
</style>
<![endif]-->
 ...
 <div id="container" >
      ...
      <div class="ad-nav">
        ...
        <div class="ad-thumbs">
		  ...
		  $defaultID = "";		  $resultArray = mysql_query("SELECT * FROM wp_gallery_slides WHERE uselink='Y'  order by created,id");
      ...
      </div>  <!-- ad -nav ends here-->

    </div>
	
    
    <div style="width:570px; height:20px; margin:5px 0 0 0; padding:4px 0;">
...
<div class="image-title" id="image-name"><?php echo $defaultImgName?></div><div id="imint" style="width:97px; height:20px; float: right">
...
<a style="cursor:pointer;" onClick="setHref()" id="im_interested" title="I am Interested" rel="gb_page_center[620, 400]" >I am Interested</a>
	...
	<div style="width:570px; height:30px; margin:0;">
...
.addthis_button_facebook_like iframe{width:50px !important; height:20px !important;}
