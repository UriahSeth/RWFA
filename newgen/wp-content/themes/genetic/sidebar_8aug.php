...
// $id=$_REQUEST['main_id'];
 ...
 $subMenuQuery = "SELECT * FROM wp_posts WHERE post_parent =155 AND menu_order >0 AND post_type='page'";
		   ...
		   <li><h3>
			...
			<?php 
				...
				if(mysql_num_rows($eventArray))
				{
			 	...
			 	?>
				 	<p id="upcom"><a href="<?php echo $permalink;?>&event_id=<?php echo $row1['event_id'];?>"><?php echo $d[1].'/'.$d[2]. "  ". $row1['event_title'];?></a></li>
			<?php
					}
	 			}else{
